...
utils=(exa unzip docker vim neovim git rsync zsh wget curl which reflector ack docker-compose zip ttf-font-awesome ttf-jetbrains-mono fzf sysstat kubectl htop ranger terraform xdotool)
