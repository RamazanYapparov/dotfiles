    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (uri) {
                ...
                yield editor.edit(editorBuilder => editorBuilder.insert(new vscode.Position(0, 0), script));
            }
            else {
                const doc = yield vscode.workspace.openTextDocument({ content: script, language: 'shellscript' });
